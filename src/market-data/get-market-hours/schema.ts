...
export const MarketSessionHoursRangeSchema = z
  .object({
    start: z.string(),
    end: z.string(),
  })
...
export const MarketSessionHoursSchema = z.record(
  z.string(),
  z.array(MarketSessionHoursRangeSchema),
);

export const MarketHoursRtnSchema = z
  .object({
    date: z.string(),
    marketType: z.string(),
    isOpen: z.boolean(),
...
export type MarketSessionHoursRange = z.infer<
  typeof MarketSessionHoursRangeSchema
>;
